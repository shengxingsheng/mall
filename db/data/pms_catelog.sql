...
insert into `pms_category`(cat_id, name, parent_cid, cat_level, show_status, sort, icon, product_unit, product_count, is_deleted, create_by, create_time, update_by, update_time)
